function driftrates = MEG2afc_load_drifts_regression(PREOUT)
...
%     temp = csvread('/Users/kloosterman/gridmaster2012/kloosterman/MATLAB/MEG_HH_analysis/behavior/params_no_blink_trials070417.csv', 1,0);
    temp = csvread('/Users/kloosterman/gridmaster2012/kloosterman/MATLAB/MEG_HH_analysis/behavior/params_REGRESSION_no_blink_trials.csv', 1,0);
...
%     temp = csvread('/home/mpib/kloosterman/MATLAB/MEG_HH_analysis/behavior/params_no_blink_trials070417.csv', 1,0);
    temp = csvread('/home/mpib/kloosterman/MATLAB/MEG_HH_analysis/behavior/params_REGRESSION_no_blink_trials.csv', 1,0);
end
...
% driftrates(:,1,:) = temp(1:18,2:3); % dimord subj drug diff

driftrates = nan(18,4,4);
driftrates(:,4,3) = temp(1:18,6); % dimord subj drug diff
driftrates(:,3,4) = temp(1:18,5); % dimord subj drug diff
