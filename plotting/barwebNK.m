...
% 				text(xdata(j),  -0.03*ymax*1.1, bw_legend(i), 'Rotation', 60, 'fontsize', 12, 'HorizontalAlignment', 'right');
				text(xdata(j),  -1, bw_legend(i), 'Rotation', 0, 'fontsize', 8, 'HorizontalAlignment', 'center'); %
			end
		end
...
% 	set(gca, 'xticklabel', groupnames, 'box', 'off', 'ticklength', [0 0], 'fontsize', 12, 'xtick',1:numgroups, 'linewidth', 1,'xgrid','off','ygrid','off');
	set(gca, 'xticklabel', groupnames, 'box', 'off', 'TickDir', 'Out', 'fontsize', 12, 'xtick',1:numgroups, 'linewidth', 1,'xgrid','off','ygrid','off');
